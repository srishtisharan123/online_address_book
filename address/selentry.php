...
mysqli_free_result($get_list_res);
    ...
    //get all addresses
    $get_addresses_sql = "SELECT address, city, state, zipcode, type FROM
...
//get all tel
$get_tel_sql = "SELECT tel_number, type FROM telephone WHERE
master_id = '".$safe_id."'";
...
//get all fax
$get_fax_sql = "SELECT fax_number, type FROM fax WHERE
master_id = '".$safe_id."'";
...
//get all email
$get_email_sql = "SELECT email, type FROM email WHERE
master_id = '".$safe_id."'";
...
//get personal note
$get_notes_sql = "SELECT note FROM personal_notes WHERE
master_id = '".$safe_id."'";
